...
const ROUTES: Dictionary = {
	"shop_to_town": [
		{"scene": "res://scenes/maps/inside_shop_map.tscn", "point": "portal_shop", "position": Vector2(20, 135), "portal_id": "portal_shop"},
		{"scene": "res://scenes/maps/town_map.tscn", "point": "shop_exit", "position": Vector2(20, 135), "portal_id": "portal_shop"}
	],
	"town_to_farm": [
	...
	"town_to_shop": [
		{"scene": "res://scenes/maps/town_map.tscn", "point": "shop_exit", "position": Vector2(95, 105), "portal_id": "portal_shop"},
		{"scene": "res://scenes/maps/inside_shop_map.tscn", "point": "shop_entry", "position": Vector2(360, 68), "portal_id": "portal_shop"}
	],
